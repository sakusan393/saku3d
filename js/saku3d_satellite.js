...
World.prototype.init = function () {
  ...
  ObjLoader.load(srcFiles1, (function(modelData){
    console.log(this)
    this.mesh = new Satellite(this.gl, this.scene3D, {modelData: modelData, specularIndex: 1});
    this.mesh.setScale(1);
    this.mesh.x = -1;
    // this.vicviper.rotationX = 10;
    this.mesh2 = new Satellite(this.gl, this.scene3D, {modelData: modelData, specularIndex: 2});
